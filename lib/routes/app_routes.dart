...
// import 'package:bagit/features/shop/screens/upload_relation/brandcategory/upload_brand_category_screen.dart';
...
class AppRoutes {
  static final pages = [
    ...
    // GetPage(name: CustomRoutes.uploadBrandCategoryRelation, page: () => const UploadBrandCategoryScreen())
  ];
}